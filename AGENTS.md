...
- Frogger: Guide a frog across busy roads and dangerous river lanes, riding moving platforms to fill all home slots before time runs out.
...
- Pac-Man: Navigate maze corridors, eat pellets and power pellets, dodge ghosts, and clear each board while chasing high scores.
...
- Slalom: Ski through uphill-scrolling snow, threading slalom gates and dodging trees as the pace accelerates.
